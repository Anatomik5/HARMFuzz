...
size_t afl_custom_fuzz(my_mutator_t *data, uint8_t *buf, size_t buf_size,
                       ...
                       size_t max_size) {
  //custom
  const size_t start_offset = 0x80050;
  const size_t end_offset = 0x80094;
  //custom                
...
//custom
  u32 mutate_range_size = end_offset - start_offset;
  u32 out_buf_len = afl_mutate(data->afl, data->buf + start_offset, mutate_range_size, 
